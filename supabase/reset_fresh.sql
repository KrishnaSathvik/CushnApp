-- SubTrackr Fresh Reset (full public reset based on current shared schema)
-- Run in Supabase SQL Editor.
-- This deletes ALL listed public tables and recreates only SubTrackr core tables.
-- auth.users is NOT dropped.

BEGIN;

-- Drop legacy + app tables from the shared schema (safe to re-run)
...
DROP TABLE IF EXISTS shared_subs CASCADE;
...
-- Optional and VERY destructive:
-- If you also want to remove all authenticated accounts, run separately:
